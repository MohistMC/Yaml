...
import com.mohistmc.snakeyaml.introspector.Property;
...
import com.mohistmc.snakeyaml.util.EnumUtils;
...
public class Constructor extends SafeConstructor {
   ...
   */
  protected class ConstructMapping implements com.mohistmc.snakeyaml.constructor.Construct {
    ...
    protected Object constructJavaBean2ndStep(MappingNode node, Object object) {
      ...
      for (NodeTuple tuple : nodeValue) {
        ...
        String key = (String) constructObject(tuple.keyNode());
        try {
   ...
   */
  protected class ConstructYamlObject implements com.mohistmc.snakeyaml.constructor.Construct {

    private com.mohistmc.snakeyaml.constructor.Construct getConstructor(Node node) {
      Class<?> cl = getClassForNode(node);
      node.setType(cl);
      // call the constructor as if the runtime class is defined
      com.mohistmc.snakeyaml.constructor.Construct constructor = yamlClassConstructors.get(node.getNodeId());
      return constructor;
    }
  ...
  protected class ConstructScalar extends AbstractConstruct {
    ...
    private Object constructStandardJavaInstance(@SuppressWarnings("rawtypes") Class type,
      ...
      if (type == String.class) {
        com.mohistmc.snakeyaml.constructor.Construct stringConstructor = yamlConstructors.get(Tag.STR);
        result = stringConstructor.construct(node);
      } else if (type == Boolean.class || type == Boolean.TYPE) {
        com.mohistmc.snakeyaml.constructor.Construct boolConstructor = yamlConstructors.get(Tag.BOOL);
        result = boolConstructor.construct(node);
      } else if (type == Character.class || type == Character.TYPE) {
        com.mohistmc.snakeyaml.constructor.Construct charConstructor = yamlConstructors.get(Tag.STR);
        ...
        com.mohistmc.snakeyaml.constructor.Construct dateConstructor = yamlConstructors.get(Tag.TIMESTAMP);
        ...
        if (type == BigDecimal.class) {
          ...
          com.mohistmc.snakeyaml.constructor.Construct doubleConstructor = yamlConstructors.get(Tag.FLOAT);
        ...
        com.mohistmc.snakeyaml.constructor.Construct intConstructor = yamlConstructors.get(Tag.INT);
    ...
    public Object construct(Node node) {
      ...
      if (Set.class.isAssignableFrom(node.getType())) {
        ...
        List<java.lang.reflect.Constructor<?>> possibleConstructors =
                new ArrayList<>(snode.getValue().size());
